  ...
  return (
    ...
    <div className="bg-gradient-to-t from-[#EFF5FA] to-[#FFFFFF]">
      <div className="w-[90%] mx-auto my-16">
        {/* Title */}
        <div>
          <h1 className="text-[54px] md:text-[46px] lxs:text-[38px] xs:text-[30px] leading-[54px] font-semibold poppins text-center italic mb-10">
            Let's Talk
          </h1>
        </div>

        {/* Form and Image Container */}
        <div className="flex lg:flex-wrap items-center justify-between gap-10 w-full">
          {/* Form Section */}
          <div className="w-[60%] lg:w-full bg-white p-6 rounded-lg">
            ...
            <div className="flex flex-col gap-5 absolute top-20 left-10">
              {data.map((item) => (
                <div className="flex items-center gap-5">
                  <img className="h-[68px] w-[68px]" src={item.image} alt={item.details} />
                  <span className="text-[20px] font-bold lato leading-[26px] text-[#FFFFFF]">
                    {item.details}
                  </span>
                </div>
              ))}
